...
from PySide6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QPushButton, 
                               ...
                               QFrame, QListWidget, QSplitter, QSizePolicy)
...
class PhyloView(QWidget):
    ...
    def run_phylo(self):
        ...
        # CRITICAL FIX: Receive and handle the (success, message) arguments
    ...
    # UPDATED: Now accepts arguments from the signal
    def on_finished(self, success, message):
        ...
        if success:
            ...
            self.log(f"❌ ERROR: {message}") # This will now show up in your log!
